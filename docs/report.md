...
- [274](https://github.com/ITU-BDSA23-GROUP21/Chirp/issues/274): Our Publictimeline and Usertimeline share alot of code. This can lead to errors when making changes to the shared code. We should refactor the code, so both pages use the same code.
