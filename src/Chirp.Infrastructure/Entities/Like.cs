...
public class Like {
    ...
    /// <summary> Is true if a cheep is liked, false if it is disliked
    ///
    /// <para> This should be remade, so it is an enum of reactions instead of a bool. 
    /// This way null is not used as a value in the <c> CheepDTO </c>, and it would be extendable to create more reaction types</para>
    /// </summary>
